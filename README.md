...
| `run_seo_audit_workflow` | Run a profile-based SEO audit orchestrator (technical, content, indexing) and return executive summary, drilldowns, and optional markdown report. |
